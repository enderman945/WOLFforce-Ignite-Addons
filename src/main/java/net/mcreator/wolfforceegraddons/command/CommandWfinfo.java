...
import net.mcreator.wolfforceegraddons.procedure.ProcedureWfinfoCommandExecuted;
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureWfinfoCommandExecuted.executeProcedure($_dependencies);
				}
			}
		}
	}
