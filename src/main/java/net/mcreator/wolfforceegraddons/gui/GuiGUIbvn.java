...
package net.mcreator.wolfforceegraddons.gui;
...
public class GuiGUIbvn extends ElementsWOLFforceIgniteaddons.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				WOLFforceIgniteaddons.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("wolfforceigniteaddons:textures/guibvn.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u00A76 Bienvenue dans le WOLFforce EGR \u00A7r", 10, 26, -16777216);
		}
		...
		protected void actionPerformed(GuiButton button) {
			WOLFforceIgniteaddons.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
